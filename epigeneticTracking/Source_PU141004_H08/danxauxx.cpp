...
void writeVoxelyzeFile( vector< vector< vector< int > > > matrixForVoxelyze )
		...
		int num_x_voxels=matrixForVoxelyze.size();
		int num_y_voxels=num_x_voxels;
		int num_z_voxels=num_x_voxels;
...
<StopConditionValue>" << 40/20 /* from <TempPeriod> */ << "</StopConditionValue>\n\
</StopCondition>\n\
<GA>\n\
